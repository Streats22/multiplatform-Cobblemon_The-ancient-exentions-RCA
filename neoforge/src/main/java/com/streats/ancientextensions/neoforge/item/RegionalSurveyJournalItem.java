package com.streats.ancientextensions.neoforge.item;

import com.streats.ancientextensions.dex.SurveyJournalReport;
...
public class RegionalSurveyJournalItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (player instanceof ServerPlayer serverPlayer) {
            SurveyJournalReport.openForPlayer(serverPlayer, hand);
            return InteractionResultHolder.success(stack);
        }
